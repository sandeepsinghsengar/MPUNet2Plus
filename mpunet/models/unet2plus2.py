...
class UNet2Plus2(Model):
    ...
    def __init__(self,
        ...
        """
        super(UNet2Plus2, self).__init__()
    ...
    def init_model(self):
    	...
    	nestnet_output=(nestnet_output_1+nestnet_output_2+nestnet_output_3+nestnet_output_4)/4
    	out = Reshape([self.img_shape[0]*self.img_shape[1], num_class], name='flatten_output')(nestnet_output)
    	return [inputs], [out]
